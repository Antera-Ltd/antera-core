      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
          ...
          <div className="flex flex-wrap gap-3 w-full md:w-auto">
              <button
                ...
                disabled={isSaving}
                className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-2 border-2 border-black font-bold uppercase text-sm hover:bg-neutral-100 transition-all text-black"
              >
