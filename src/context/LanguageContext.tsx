...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'blog.latest_briefings': 'Latest Briefings',
    ...
    'page.models.desc': 'We use data to help you understand your business and predict the future.',
  ...
  sw: {
    ...
    'hero.title_part1': 'Kuzalisha Biashara Yako',
    'hero.title_part2': 'Kwa Teknolojia ya Kisasa.',
    'hero.description': 'Tunatengeneza programu za simu, tovuti, na zana za AI ili kusaidia biashara yako kukua haraka na kufanya kazi vizuri zaidi.',
    ...
    'blog.latest_briefings': 'Maelezo ya Karibuni',
  ...
  pl: {
    ...
    'hero.title_part1': 'Rozwijaj Swój Biznes',
    'hero.title_part2': 'Z Nowoczesną Technologią.',
    'hero.description': 'Tworzymy aplikacje mobilne, strony internetowe i narzędzia AI, które pomagają Twojej firmie rosnąć szybciej i działać sprawniej.',
    ...
    'blog.latest_briefings': 'Najnowsze briefingi',
