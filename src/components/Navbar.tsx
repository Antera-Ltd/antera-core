...
// This commented code below is the legacy version of the Navbar component, which has been refactored and improved in the current implementation above. The legacy code is kept for reference and comparison purposes, but it is not used in the current application.
// 'use client';
...
//         className={`w-full flex items-center justify-between px-6 py-4 transition-colors duration-200 border-b ${
//           isOpen 
//             ? 'bg-black/40 backdrop-blur-2xl backdrop-saturate-150 text-white border-white/20' 
//             : 'bg-white text-black border-neutral-200'
//         }`}
//       >
//         {/* Logo - Image integrated next to text branding */}
...
//                   exit={{ opacity: 0, y: 4 }}
//                   className={`absolute right-0 top-[48px] border shadow-sm w-24 flex flex-col ${
//                     isOpen ? 'bg-black/60 backdrop-blur-2xl border-white/20' : 'bg-white border-neutral-200'
//                   }`}
//                 >
//                   {languages.map((lang) => (
//                     <button
...
//                       }}
//                       className={`w-full px-4 py-3 text-left text-sm font-medium transition-colors border-b last:border-none ${
//                         isOpen ? 'border-white/10' : 'border-neutral-100'
//                       } ${
//                         language === lang.code 
//                           ? 'bg-[#FA520F] text-white' 
//                           : isOpen 
...
//             exit={{ opacity: 0, y: -10 }}
//             transition={{ duration: 0.2 }}
//             className="absolute top-full left-0 w-full h-[100vh] overflow-y-auto pb-32 bg-black/40 backdrop-blur-2xl backdrop-saturate-150 border-t border-white/20 text-white"
//           >
//             <div className="max-w-[1600px] mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-12 gap-12">
...
//               <div className="lg:col-span-6 pr-8">
//                 <div className="flex justify-between items-center border-b border-white/15 pb-3 mb-6">
...
//                     href="/blog" 
//                     onClick={() => setIsOpen(false)}
//                     className="text-[10px] font-bold text-zinc-300 hover:text-white tracking-widest uppercase transition-colors flex items-center gap-1"
//                   >
//                     View Blog <ArrowRight className="w-3 h-3" />
//                   </Link>
//                 </div>
...
//                         {post.desc}
//                       </p>
//                       <span className="text-sm font-medium mt-1 group-hover:underline flex items-center gap-2 text-zinc-200">
//                         Read More <ArrowRight className="w-4 h-4" />
//                       </span>
//                     </Link>
//                   ))}
...
//                 {/* Latest Platforms Section */}
//                 <div className="flex justify-between items-center border-b border-white/15 pb-3 mt-12 mb-6">
//                   <span className="text-[10px] font-bold text-zinc-300 tracking-widest uppercase">
//                     Our Platforms
//                   </span>
//                   <Link 
...
//                     href="/company"
//                     onClick={() => setIsOpen(false)}
//                     className="text-[10px] font-bold text-zinc-300 hover:text-white tracking-widest uppercase transition-colors"
//                   >
//                     About Us ↗
//                   </Link>
//                 </div>
//                 <p className="text-[15px] text-zinc-200 leading-relaxed mb-6">
//                   Enterprise Webs, Mobile Apps, Organization Sites and Digital Platform Development for the modern African market.
//                 </p>
