          ...
          <FadeIn>
            <div className="max-w-xl">
              <h2 className="text-4xl md:text-5xl font-bold mb-8 tracking-tight leading-tight">
                Technology That Works Across Your <span className="font-serif italic font-normal text-brand-orange">Entire</span> Organization
              </h2>
              <p className="text-brand-cream/60 text-lg leading-relaxed font-light mb-8">
        ...
        <FadeIn direction="none">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
            <div className="max-w-2xl">
              <h2 className="text-5xl md:text-6xl font-bold tracking-tight mb-6 text-brand-cream">What We Build</h2>
              <p className="text-brand-cream/40 text-xl font-light">End-to-end technical solutions designed for scale and impact.</p>
            </div>
            ...
            {services.map((service, i) => (
              <StaggerItem key={i}>
                <div className="p-10 border-r border-b border-white/10 hover:bg-brand-gray-900 transition-all group h-full">
                  ...
                  <p className="text-brand-cream/40 leading-relaxed text-sm font-light">
                    {service.desc}
                  </p>
                </div>
              </StaggerItem>
